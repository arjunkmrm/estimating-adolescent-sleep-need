...
# data.nonap <- data.nonap %>% filter(!subj %in% c("NFS044", "NFS2032", "NFS4024", "NFS4031", "NFS4051"))
...
#SLEEP TIME ESTIMATES - all groups
...
#                    random = crit ~ 1,
#                    groups = ~ subj,
#                    start = c(b = 1.5, theta = 0.6, crit = 14),
#                    na.action = na.omit
#                    ) 
