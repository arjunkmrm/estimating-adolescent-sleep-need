...
```{r, message=FALSE, echo=FALSE, fig.width=8, fig.height=6, dpi=300}
...
ggplot(RMSE.long, aes(x=measure, value, label = round(value, 2))) +
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 0.5)) + xlab('data') + geom_text(vjust = 0.8, nudge_y = 0.7) + 
  labs(color = 'measure') + scale_color_discrete(labels = c("RMSE", "Sleep Need", 'Theta'))
